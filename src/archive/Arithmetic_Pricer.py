...
resultsss = Monte_Carlo_lognormal(iterations=1000000, K=110, T=1, r=0.1)
################# Difference X-Y #################
...
results = Monte_Carlo_Arithmetic(iterations=1000000, K=110, T=1, r=0.1, N=150, S0=100, sigma=0.3)
lower = results
